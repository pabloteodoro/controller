...
export function FormTicket() {
    ...
    return(
        <form className="bg-slate-200 mt-6 px-4 py-6 rounded border-2">
            ...
            <textarea className="w-full border-2 rounded-md h-24 resize-none mb-2 px-2"
            ...
            <button type="submit" className="bg-blue-500 rounded-md w-full px-2 text-white font-bold">
                Cadastrar
            </button>
        </form>
    )
